  ...
  const analyzeResume = async () => {
    ...
    if (!jobDescription.trim()) {
      toast({
        ...
        description:
          "Please paste the complete job description (at least 20 words)",
      });
    ...
    try {
      ...
      if (response.status === 429) {
        toast({
          ...
          description:
            "API quota exceeded. Please try again later or check your OpenRouter plan.",
        });
        setIsAnalyzing(false);
        return;
      }
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <a
                href="#features"
                className="text-m font-medium text-muted-foreground hover:text-primary transition-colors duration-300 hover:scale-105"
              >
                Features
              </a>
              <a
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center max-w-4xl mx-auto animate-fade-in">
            ...
            <p className="text-lg md:text-xl lg:text-2xl mb-8 text-white/90 leading-relaxed">
              Get your resume past Applicant Tracking Systems with our
              professional ATS compatibility checker. Upload your resume and job
              description for instant, actionable feedback.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Over 75% of resumes never reach human eyes. Applicant Tracking
              Systems filter out unoptimized resumes before recruiters see them.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="p-8 shadow-card  border-blue-500 bg-gradient-card text-center animate-fade-in transition transform duration-300 hover:scale-101 hover:shadow-xl">
              ...
              <p className="text-muted-foreground">
                Ensure your resume uses the right format, fonts, and structure
                that ATS systems can easily parse and understand.
              </p>
            </Card>

            <Card
              className="p-8 shadow-card b border-blue-500 bg-gradient-card text-center animate-fade-in transition transform duration-300 hover:scale-101 hover:shadow-xl"
              style={{ animationDelay: "0.2s" }}
            >
              <Target className="mx-auto h-16 w-16 text-secondary mb-6" />
              <h3 className="text-2xl font-bold mb-4">Keyword Optimization</h3>
              <p className="text-muted-foreground">
                Match your resume keywords with job descriptions to increase
                your chances of passing initial ATS screening.
              </p>
            </Card>

            <Card
              className="p-8 shadow-card  border-blue-500 bg-gradient-card text-center animate-fade-in transition transform duration-300 hover:scale-101 hover:shadow-xl"
              style={{ animationDelay: "0.4s" }}
            >
              <Zap className="mx-auto h-16 w-16 text-accent mb-6" />
              <h3 className="text-2xl font-bold mb-4">Instant Analysis</h3>
              <p className="text-muted-foreground">
                Get real-time feedback on your resume's ATS compatibility score
                and detailed suggestions for improvement.
              </p>
            </Card>
          </div>
        </div>
      ...
      <section id="how-it-works" className="py-20 border-t-2 border-black-500">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Our advanced algorithm analyzes your resume against industry
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="p-6 border-blue-500 shadow-lg rounded-xl text-center hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-muted-foreground text-sm text-justify">
                Upload your resume in PDF or DOCX format for comprehensive
                analysis.
              </p>
            </Card>
            ...
            <Card className="p-6 border-blue-500 shadow-lg rounded-xl text-center hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-muted-foreground text-sm text-justify">
                Our AI scans for ATS compatibility, keywords, and formatting
                issues.
              </p>
            </Card>
            ...
            <Card className="p-6 border-blue-500 shadow-lg rounded-xl text-center hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-muted-foreground text-sm ">
                Receive a detailed ATS report with scores, missing skills, and
                recommendations.
              </p>
            </Card>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Follow these essential guidelines to ensure your resume passes
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Stick to conventional headers like "Work Experience",
                        "Education", "Skills" instead of creative alternatives.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Use readable fonts like Arial, Calibri, or Times New
                        Roman. Avoid decorative or script fonts.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Mirror the language and keywords from the job
                        description throughout your resume naturally.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Use numbers, percentages, and specific metrics to
                        demonstrate your impact and results.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <Card className="p-8 shadow-card bg-gradient-card border-blue-500">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-muted-foreground mt-2">
                      Upload your resume now and get instant ATS compatibility
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-white/90">
              Join thousands of professionals who have improved their resume's
              ATS compatibility
            </p>
          </div>
      ...
      <div id="upload-section" className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card
            className="p-8 shadow-card bg-gradient-card mt-8 animate-slide-up border-blue-500"
            style={{ animationDelay: "0.2s" }}
          >
            <div className="text-center mb-6">
              ...
              <p className="text-muted-foreground">
                Paste the complete job description(try clear summary description
                without much spaces)
              </p>
            </div>
